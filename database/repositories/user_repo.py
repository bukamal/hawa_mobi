...
class UserRepository(BaseRepository):
    ...
    def create(self, username: str, password: str, full_name: str, role: str) -> int:
        ...
        cur = conn.execute("INSERT INTO users (username, password_hash, salt, full_name, role, created_at) VALUES (?,?,?,?,?,?)",
    ...
    def change_password(self, user_id: int, old_password: str, new_password: str) -> bool:
        ...
        if not user or not verify_password(old_password, user['password_hash'], user['salt']): return False
