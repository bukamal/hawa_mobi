...
res = repo.add_payment_on_behalf(
    "الشركة التي دفعت", "الشركة الدائنة", 1500, "SYP", "2026-07-10", "اختبار", 1
)
...
try:
    ...
    raise AssertionError(
        "generated third-party expense should not be deletable individually"
    )
except ValueError:
    pass
...
assert (
    len([r for r in records if r.get("source_type") == "third_party_payment_reversal"])
    == 2
)
