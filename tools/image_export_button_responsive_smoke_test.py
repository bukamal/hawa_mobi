...
assert "on_click=self._share_statement_image_async" in company_view
...
assert "run_async_task(self._page, self._share_statement_image_async)" not in company_view

assert "on_click=self._export_png_async" in reports_view
...
assert "run_async_task(self._page, self._export_png_async)" not in reports_view
