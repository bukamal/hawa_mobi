...
assert 'from views.ui_kit import' in layout and 'TEXT' in layout.split('from views.ui_kit import', 1)[1].split('\n', 1)[0], 'TEXT must be imported from ui_kit, not left as a runtime NameError'
