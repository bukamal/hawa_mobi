...
required = [
    ...
    ("AlertDialog is converted to bottom sheet host", "host = _build_bottom_sheet_host(page, control)" in compat),
    ("bottom sheet host builder defined", "def _build_bottom_sheet_host" in compat),
