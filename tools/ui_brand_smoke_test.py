...
assert "ft.ImageFit" not in text, (
    "Use string-based image_fit() for Flet APK compatibility"
)
...
assert (
    "icon_android.png" not in pyproject
)  # Flet uses assets/icon_android.png by convention
